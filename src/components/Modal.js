        ...
        <>
            ...
            <div className={`fixed inset-0 m-auto max-w-sm h-max bg-neutral-800 text-white rounded-md z-50 font-bold inter-ff
                ...
                <div className="relative border-b border-b-neutral-700">
                    <h1 className="text-lg text-center py-3 font-bold">Reach me at</h1>
                ...
                <div className="flex flex-col p-2">
                    <Link to='https://www.messenger.com/t/100036289026538' className="flex items-center hover:bg-neutral-600 py-3 px-2 rounded-lg my-1">
                    ...
                    <Link to='' className="flex items-center hover:bg-neutral-600 py-3 px-2 rounded-lg my-1">
                        <BsTwitter className="text-xl sm:text-2xl me-2" /><span>Twitter</span>
                    </Link>
