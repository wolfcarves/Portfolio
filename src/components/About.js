    ...
    return (
        <>
            <div className='about relative container mx-auto flex w-full text-xl py-24 px-2'>
                <div className='flex flex-col sm:items-baseline items-center sm:text-left text-center'>
                    ...
                    <Link to='/projects' className="flex items-center w-max inter-ff px-12 py-4 mt-8 
